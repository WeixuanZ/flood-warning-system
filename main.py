...
key_station_in_cluster = sorted(key_station_in_cluster, key=lambda x: mean_levels[key_station_in_cluster.index(x)],
                                reverse=True)
...
notice = Div(
    text="""<footer>&copy; Copyright 2020 Weixuan Zhang, Ghifari Pradana. CUED Part 1A Lent computing project.</footer>""",
    width=600)
